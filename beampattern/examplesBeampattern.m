...
%% Plot the beampattern for various frequencies with plotBeampattern function
...
plotBeampattern(xPos, yPos, zPos, elementWeights, f, c, thetaSteeringAngle, sliceAngle, dynamicRange)
